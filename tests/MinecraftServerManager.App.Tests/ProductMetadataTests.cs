...
public sealed class ProductMetadataTests
{
    ...
    public void ApplicationAssembly_UsesMuhunBrandAndVersionedOutputName()
    {
        ...
        Assert.Equal("1.0.7.0", versionInfo.FileVersion);
        Assert.Equal("1.0.7", versionInfo.ProductVersion);
        ...
        Assert.Equal("1.0.7.0", coreAssembly.GetName().Version?.ToString());
        Assert.Equal(
            "1.0.7",
        ...
        Assert.Equal("1.0.7.0", remoteAssembly.GetName().Version?.ToString());
        Assert.Equal(
            "1.0.7",
    ...
    public void ApplicationManifest_UsesCurrentAssemblyIdentityVersion()
    {
        ...
        Assert.Equal("1.0.7.0", (string?)identity.Attribute("version"));
    }
    ...
    public void ProjectMetadata_UsesCurrentVersionAndKeepsWindowsFormsTraySupport()
    {
        ...
        Assert.Equal("1.0.7", SingleProperty(appProperties, "Version"));
        Assert.Equal("1.0.7.0", SingleProperty(appProperties, "AssemblyVersion"));
        Assert.Equal("1.0.7.0", SingleProperty(appProperties, "FileVersion"));
        Assert.Equal("1.0.7", SingleProperty(appProperties, "InformationalVersion"));
        ...
        Assert.Equal("1.0.7", SingleProperty(coreProperties, "Version"));
        Assert.Equal("1.0.7.0", SingleProperty(coreProperties, "AssemblyVersion"));
        Assert.Equal("1.0.7.0", SingleProperty(coreProperties, "FileVersion"));
        Assert.Equal("1.0.7", SingleProperty(coreProperties, "InformationalVersion"));
        ...
        Assert.Equal("1.0.7", SingleProperty(remoteProperties, "Version"));
        Assert.Equal("1.0.7.0", SingleProperty(remoteProperties, "AssemblyVersion"));
        Assert.Equal("1.0.7.0", SingleProperty(remoteProperties, "FileVersion"));
        Assert.Equal("1.0.7", SingleProperty(remoteProperties, "InformationalVersion"));
    }
