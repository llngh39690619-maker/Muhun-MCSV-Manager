...
{
    private const string CurrentVersion = "1.2.8";
    private const string CurrentAssemblyVersion = "1.2.8.0";
    ...
    public void ApplicationAssembly_UsesXBrandAndKeepsCompatibleOutputName()
    {
        ...
        Assert.Equal("1.2.8.0", versionInfo.FileVersion);
        Assert.Equal("1.2.8", versionInfo.ProductVersion);
        ...
        Assert.Equal("1.2.8.0", coreAssembly.GetName().Version?.ToString());
        Assert.Equal(
            "1.2.8",
        ...
        Assert.Equal("1.2.8.0", remoteAssembly.GetName().Version?.ToString());
        Assert.Equal(
            "1.2.8",
    ...
    public void ApplicationManifest_UsesCurrentAssemblyIdentityVersion()
    {
        ...
        Assert.Equal("1.2.8.0", (string?)identity.Attribute("version"));
    }
