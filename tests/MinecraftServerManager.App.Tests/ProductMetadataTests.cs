...
{
    private const string CurrentVersion = "1.2.7";
    private const string CurrentAssemblyVersion = "1.2.7.0";
    ...
    public void ApplicationAssembly_UsesXBrandAndKeepsCompatibleOutputName()
    {
        ...
        Assert.Equal("1.2.7.0", versionInfo.FileVersion);
        Assert.Equal("1.2.7", versionInfo.ProductVersion);
        ...
        Assert.Equal("1.2.7.0", coreAssembly.GetName().Version?.ToString());
        Assert.Equal(
            "1.2.7",
        ...
        Assert.Equal("1.2.7.0", remoteAssembly.GetName().Version?.ToString());
        Assert.Equal(
            "1.2.7",
    ...
    public void ApplicationManifest_UsesCurrentAssemblyIdentityVersion()
    {
        ...
        Assert.Equal("1.2.7.0", (string?)identity.Attribute("version"));
    }
