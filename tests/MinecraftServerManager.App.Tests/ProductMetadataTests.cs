...
public sealed class ProductMetadataTests
{
    ...
    public void ApplicationAssembly_UsesXBrandAndKeepsCompatibleOutputName()
    {
        ...
        Assert.Equal("1.2.2.0", versionInfo.FileVersion);
        Assert.Equal("1.2.2", versionInfo.ProductVersion);
        ...
        Assert.Equal("1.2.2.0", coreAssembly.GetName().Version?.ToString());
        Assert.Equal(
            "1.2.2",
        ...
        Assert.Equal("1.2.2.0", remoteAssembly.GetName().Version?.ToString());
        Assert.Equal(
            "1.2.2",
    ...
    public void ApplicationManifest_UsesCurrentAssemblyIdentityVersion()
    {
        ...
        Assert.Equal("1.2.2.0", (string?)identity.Attribute("version"));
    }
    ...
    public void ProjectMetadata_UsesCurrentVersionAndKeepsWindowsFormsTraySupport()
    {
        ...
        Assert.Equal("1.2.2", SingleProperty(appProperties, "Version"));
        Assert.Equal("1.2.2.0", SingleProperty(appProperties, "AssemblyVersion"));
        Assert.Equal("1.2.2.0", SingleProperty(appProperties, "FileVersion"));
        Assert.Equal("1.2.2", SingleProperty(appProperties, "InformationalVersion"));
        ...
        Assert.Equal("1.2.2", SingleProperty(coreProperties, "Version"));
        Assert.Equal("1.2.2.0", SingleProperty(coreProperties, "AssemblyVersion"));
        Assert.Equal("1.2.2.0", SingleProperty(coreProperties, "FileVersion"));
        Assert.Equal("1.2.2", SingleProperty(coreProperties, "InformationalVersion"));
        ...
        Assert.Equal("1.2.2", SingleProperty(remoteProperties, "Version"));
        Assert.Equal("1.2.2.0", SingleProperty(remoteProperties, "AssemblyVersion"));
        Assert.Equal("1.2.2.0", SingleProperty(remoteProperties, "FileVersion"));
        Assert.Equal("1.2.2", SingleProperty(remoteProperties, "InformationalVersion"));
    }
