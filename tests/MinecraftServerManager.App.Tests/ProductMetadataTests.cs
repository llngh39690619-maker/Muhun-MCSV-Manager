...
{
    private const string CurrentVersion = "1.2.9-beta.23";
    ...
    [
        ...
        "MinecraftServerManager.Installer/MinecraftServerManager.Installer.csproj",
    ...
    public void ApplicationAssembly_UsesXBrandAndKeepsCompatibleOutputName()
    {
        ...
        Assert.Equal(CurrentAssemblyVersion, versionInfo.FileVersion);
        Assert.Equal(CurrentVersion, versionInfo.ProductVersion);
        ...
        Assert.Equal(CurrentAssemblyVersion, coreAssembly.GetName().Version?.ToString());
        Assert.Equal(
            CurrentVersion,
        ...
        Assert.Equal(CurrentAssemblyVersion, remoteAssembly.GetName().Version?.ToString());
        Assert.Equal(
            CurrentVersion,
    ...
    public void ApplicationManifest_UsesCurrentAssemblyIdentityVersion()
    {
        ...
        Assert.Equal(CurrentAssemblyVersion, (string?)identity.Attribute("version"));
    }
