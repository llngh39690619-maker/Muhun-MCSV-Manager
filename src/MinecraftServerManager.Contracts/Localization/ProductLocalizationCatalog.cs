...
public static partial class ProductLocalizationCatalog
{
    ...
    [
        ...
        "main.workspace.server", "main.workspace.client", "main.remote",
        "main.serverInspector.actions", "main.serverInspector.information",
        "main.serverInspector.serviceManaged", "main.serverInspector.localManaged",
        ...
        "server.state.stopped", "server.java.unspecified", "server.port.listening",
        "server.port.notListening", "server.memory.executableHint",
        ...
        "online.curseForgeApiKeyPrivacy", "online.curseForgeCredential.save",
        "online.curseForgeCredential.delete", "online.curseForgeCredential.saved",
        "online.curseForgeCredential.notSaved", "online.curseForgeCredential.typedNotSaved",
        "online.curseForgeCredential.enterToSave", "online.curseForgeCredential.unavailable",
        "online.curseForgeCredential.saveFailed", "online.curseForgeCredential.deleteFailed",
        "online.curseForgeCredential.deleted", "online.curseForgeCredential.readFailed",
        "online.curseForgeCredential.rejected", "online.curseForgeCredential.editFile",
        "online.curseForgeCredential.editingFile", "online.curseForgeCredential.openFileFailed",
        "online.curseForgeCredential.imported", "online.curseForgeCredential.fileEmpty",
        "online.curseForgeCredential.fileInvalid", "online.curseForgeCredential.importFailed",
        "online.curseForgeCredential.fileMissing",
        ...
        "remote.service.state.disabled", "remote.service.state.waiting",
        "remote.service.state.unavailable", "remote.service.state.blocked",
        "remote.service.state.retrying", "remote.service.state.running",
        "remote.service.state.configured", "remote.service.state.configuredCached",
        "remote.service.state.awaitingVerification", "remote.service.state.awaitingRemoval",
        "remote.service.hostStopped", "remote.service.funnelConnected",
        "remote.service.funnelDisconnected", "remote.service.funnelConfiguredCached",
        "remote.service.retryAt", "remote.service.routeLastVerified",
        "remote.service.refreshed", "remote.service.started", "remote.service.stopped",
        "remote.service.reconnected", "remote.service.lifecycleFailure",
        "remote.service.tailscale.loginRequired", "remote.service.tailscale.loginOpening",
        "remote.service.tailscale.loginLaunchFailed", "remote.service.tailscale.waiting",
        "remote.service.tailscale.recoveryTimedOut", "remote.service.tailscale.connected",
        "remote.service.tailscale.notInstalled", "remote.service.tailscale.statusInvalid",
        "remote.service.tailscale.statusFailed", "remote.service.tailscale.localApiIdentityConflict",
        "remote.service.tailscale.localApiAccessDenied",
        "remote.service.tailscale.httpsRequired", "remote.service.tailscale.hostnameUnavailable",
        "remote.service.tailscale.hostnameSetFailed", "remote.service.tailscale.hostnameStatusFailed",
        "remote.service.tailscale.routeConflict", "remote.service.usernameInvalid",
        ...
        "modpackUpdate.curseForgeCredential.remember",
    ...
    private static readonly IReadOnlyDictionary<string, int> ParameterCounts =
        new ReadOnlyDictionary<string, int>(new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["server.port.listening"] = 1,
            ["server.port.notListening"] = 1,
            ...
            ["remote.service.routeLastVerified"] = 1,
            ...
            ["remote.service.lifecycleFailure"] = 1,
            ["remote.service.tailscale.loginRequired"] = 1,
            ["remote.service.tailscale.loginOpening"] = 1,
            ["remote.service.tailscale.loginLaunchFailed"] = 1,
            ["remote.service.tailscale.waiting"] = 1,
            ["remote.service.tailscale.recoveryTimedOut"] = 1,
            ["remote.service.tailscale.connected"] = 1,
            ["remote.service.tailscale.notInstalled"] = 1,
            ["remote.service.tailscale.statusInvalid"] = 1,
            ["remote.service.tailscale.statusFailed"] = 1,
            ["remote.service.tailscale.localApiIdentityConflict"] = 1,
            ["remote.service.tailscale.localApiAccessDenied"] = 1,
            ["remote.service.tailscale.httpsRequired"] = 1,
            ["remote.service.tailscale.hostnameUnavailable"] = 1,
            ["remote.service.tailscale.hostnameSetFailed"] = 1,
            ["remote.service.tailscale.hostnameStatusFailed"] = 1,
            ["remote.service.tailscale.routeConflict"] = 1,
